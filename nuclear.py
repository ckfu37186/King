...
TELEGRAM_BOT_TOKEN = '7442188342:AAGdEnwU7j7SWHe2qmnxUREwGfzbdcCeo-g '
ADMIN_USER_ID = 5993004087
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*🔗JOIN:- https://t.me/+PQ5JbHy9pphhMjM9*"
...
async def attack(update: Update, context: CallbackContext):
    ...
    await context.bot.send_message(chat_id=chat_id, text=(
        f"*🔰 HAMLAH KIYA GAYA.! 🔰*\n"
        f"*🎯  HIDAF: {ip}:{port}*\n"
        f"*🕒 MADAT: {duration} seconds*\n"
        f"*🔥 ANTI BAN PAROXI SURU HO RAHA HAI ♻️\n\n🔗JOIN:- https://t.me/+PQ5JbHy9pphhMjM9 *"
    ), parse_mode='Markdown')
